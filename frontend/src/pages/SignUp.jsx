 ...
 border-2 border-[#1a1f23]"
      >
        ...
        >
          ...
          [90%] h-[50px] rounded-2xl mt-[30px] border-2 border-black"
...
//               className="border border-gray-600 rounded-xl px-4 py-3 text-white bg-gray-800
//               focus:outline-none focus:ring-2 focus:ring-[#9b5de5] shadow-sm
//               focus:shadow-[0_0_12px_#9b5de5] placeholder-gray-400"
//             />
